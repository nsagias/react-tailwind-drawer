export default function GridLayout() {
  return (
    <>
    <div className="bg-yellow-300 min-h-full min-w-full flex items-center justify-center p-5 shrink-0">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-4 gap-y-4 min-h-full min-w-full">
        <div className="col-span-1 md:col-span-2 lg:row-span-2 bg-black p-3 rounded text-white h-screen w-full box">1</div>
